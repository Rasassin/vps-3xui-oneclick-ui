...
v1.48 adds release command checklists
...
- `SIGNED_ARTIFACT_VALIDATION_vX.Y.Z.md`
- `GO_LIVE_READINESS_vX.Y.Z.md`
...
- Generate `dist/SIGNED_ARTIFACT_VALIDATION_vX.Y.Z.md`.
- Generate `dist/GO_LIVE_READINESS_vX.Y.Z.md`.
