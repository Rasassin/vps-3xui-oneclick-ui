...
from deployer.signing_evidence_manifest import check_manifest, manifest_checks_overall_status


def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Check the signing evidence manifest without signing binaries, notarizing, "
