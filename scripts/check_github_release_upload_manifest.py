...
from deployer.github_release_upload_manifest import check_manifest, manifest_checks_overall_status


def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Check the local GitHub Release upload manifest without pushing, uploading, "
