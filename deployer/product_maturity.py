...
def collect_maturity_gates() -> list[MaturityGate]:
    return [
        ...
        MaturityGate("Real VPS compatibility matrix", 0, 8, "pending", "The worksheet exists, but supported-provider VPS tests are still manual and not completed as release evidence."),
