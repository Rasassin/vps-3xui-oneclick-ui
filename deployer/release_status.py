...
def expected_release_artifacts(version: str = APP_VERSION) -> list[tuple[str, Path]]:
    ...
    return [
        ...
        ("VPS 下一批兼容性测试计划", dist_dir / f"VPS_COMPATIBILITY_NEXT_TESTS_v{version}.md"),
        ...
        ("GitHub Desktop 发布步骤", dist_dir / f"GITHUB_DESKTOP_PUBLISH_STEPS_v{version}.md"),
        ...
        ("外部发布证据报告", dist_dir / f"EXTERNAL_RELEASE_EVIDENCE_v{version}.md"),
        ("外部证据命令单", dist_dir / f"EXTERNAL_EVIDENCE_COMMANDS_v{version}.md"),
        ("外部发布操作手册", dist_dir / f"EXTERNAL_OPERATOR_GUIDE_v{version}.md"),
        ("外部下一步动作报告", dist_dir / f"EXTERNAL_NEXT_ACTIONS_v{version}.md"),
        ("外部发布 Go-No-Go 报告", dist_dir / f"EXTERNAL_GO_NO_GO_v{version}.md"),
        ("外部发布一致性报告", dist_dir / f"EXTERNAL_RELEASE_CONSISTENCY_v{version}.md"),
        ("外部发布一致性 JSON", dist_dir / f"EXTERNAL_RELEASE_CONSISTENCY_v{version}.json"),
        ("发布渠道报告", dist_dir / f"RELEASE_CHANNELS_v{version}.md"),
        ("外部发布交接包", dist_dir / f"EXTERNAL_RELEASE_HANDOFF_v{version}.zip"),
        ("外部发布交接包校验文件", dist_dir / f"SHA256SUMS_EXTERNAL_RELEASE_HANDOFF_v{version}.txt"),
